...
export function RegisterForm({changeStep, changeMode}) {
    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <input type="password" name="passwordRep" placeholder="Repeat password"onChange={handleChange} onBlur={handleBlur} value={form.passwordRep} required/>
                <div className="error-container">
