...
export function LoginForm({changeStep, changeMode}) {
        ...
        <>
            <form onSubmit={handleSubmit}>
                ...
                <div className="options">
                    <input type="checkbox" name="remember" onChange={handleChange} onBlur={handleBlur} value={form.remember}/>
                    <label htmlFor="remember">Remember me</label>
                    <p onClick={() => {changeMode("Password")}}>Forgot Password?</p>
                </div>
            ...
            <p>No account? <strong onClick={()=>{changeMode("Register")}}>Register now</strong></p>
        </>
    )
}