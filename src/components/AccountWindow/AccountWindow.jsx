...
import { LRModal } from "../Forms/LRModal"
...
export function AccountWindow({mode, setModalMode, setUserLoggedIn}) {
    ...
    if (mode === "Login" || mode === "Register") {
        title = mode
        base = <LRModal mode={mode} setModalMode={setModalMode} setUserLoggedIn={setUserLoggedIn}/>
    } else if (mode === "VerificationEmail" || mode === "VerificationPassword") {
        title = "Verification"
        base = <VerificationForm mode={mode} setModalMode={setModalMode}/>
    } else if (mode === "User Information") {
        title = mode
        base = <UserInfoForm setModalMode={setModalMode}/>
    } else if (mode === "DoneRegister" || mode === "DonePassword") {
        // En vez de logo viene check icon
        title = "Process Finished"
        base = <DoneMessage mode={mode} setModalMode={setModalMode} setUserLoggedIn={setUserLoggedIn}/>
    } else if (mode === "Forgotten Password") {
        title = mode
        base = <ForgotPasswordForm setModalMode={setModalMode}/>
    } else if (mode === "New Password") {
        title = mode
        base = <NewPasswordForm setModalMode={setModalMode}/>
    } else return
